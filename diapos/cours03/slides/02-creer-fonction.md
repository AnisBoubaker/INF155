...
- Si la fonction **retourne** une valeur: adopte généralement une forme nominale
(ex.: moyenne_notes, saisie, etc.).
- Si la fonction **ne retourne pas** de valeur: adopte généralement un forme verbale
(ex.: afficher_menu) 
